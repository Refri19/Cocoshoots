...
export default function LoginPage() {
  ...
  // 1. UPDATED: Handle Standard Email Login
  // app/login/page.tsx
    ...
    try {
      ...
      if (email === 'admin@example.com' && password === 'admin123' ) {
        ...
        const result = await signIn('credentials', {
          email,
          password,
          redirect: false, // Set to false so we can handle the redirect manually
        });
        ...
        if (result?.ok) {
          ...
          alert("Authentication failed. Check your NextAuth configuration.");
        }
